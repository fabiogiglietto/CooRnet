...
#### [Watch the video](https://www.youtube.com/watch?v=uezja4iL6yM "Link to YouTube video recording of the tutorial session")
...
This tutorial will be held online on June 26th 2022 and it is organized as part of the [14th ACM Web Science Conference 2022](https://websci22.webscience.org/).
...
Registration fee for attending this tutorial is included in the general WebSci22 conference registration, or can be booked seperately as workshop/tutorial only registration. See the [registration page](https://websci22.webscience.org/registration/) for details.
