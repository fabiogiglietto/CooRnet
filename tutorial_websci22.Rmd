...
Fabio Giglietto, Associate Professor, University of Urbino Carlo Bo, [fabio.giglietto\@uniurb.it](mailto:fabio.giglietto@uniurb.it)
Luca Rossi, Associate Professor, IT University of Copenhagen, [lucr\@itu.dk](mailto:lucr@itu.dk)\
...
[Prerequisites:\
\
]{.ul}Coornet is a package for R thus a [recent version of R](https://cran.r-project.org/bin/)- ideally with an IDE such as [RStudio](https://www.rstudio.com/products/rstudio/download/) or [VSCode](https://code.visualstudio.com/download)- is required to participate. Knowledge of R is helpful but not necessary to participate.
