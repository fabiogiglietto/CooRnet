...
clean_urls <- function(df, url){
  ...
  df <- df[!grepl("https://www.instagram.com/", df[[url]]), ] # remove link to instagram domain name
  df <- df[!grepl("https://www.facebook.com/", df[[url]]), ] # remove link to facebook domain name
  df <- df[!grepl("https://www.twitter.com/", df[[url]]), ] # remove link to twitter domain name
  df <- df[!grepl("https://www.youtube.com/", df[[url]]), ] # remove link to youtube domain name
