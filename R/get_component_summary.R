...
#' Its value is calculated by dividing, for each entity in a coordinated netwok, its \code{\link[igraph]{strength}} by its \code{\link[igraph]{degree}}, and then calculating the average by component of these values.
#'
#' @examples
